...
public class Corolla implements Car {
	...
	@Qualifier("v8")		// we need qualifier to remove ambiguity as 2 engines implements Engine Interface.
	Engine engine;


	/*
	 * public Corolla(Engine engine) { // if we are using constructor then no need
	 * to autowire specially property autowire is good// super();
	 * engine.type="New V8 from constructor"; this.engine = engine;
	 */
